...
$config['default']['mongo_hostbase'] = getenv('MONGOLAB_DB_HOST');
$config['default']['mongo_database'] = getenv('MONGOLAB_DB_NAME');
$config['default']['mongo_username'] = getenv('MONGOLAB_USERNAME');
$config['default']['mongo_password'] = getenv('MONGOLAB_PASSWORD');
